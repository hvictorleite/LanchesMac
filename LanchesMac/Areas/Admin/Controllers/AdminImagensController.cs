...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        {
            string _imageDeleta = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.NomePastaImagensProdutos + "\\", fname );

            if (System.IO.File.Exists(_imageDeleta))
            {
                System.IO.File.Delete(_imageDeleta);
                ViewData["Deletado"] = $"Arquivo(s) {_imageDeleta} deletado(s) com sucesso";
            }
